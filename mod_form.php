...
/**
 * The main mod_smartspe configuration form.
 *
...
class mod_smartspe_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'name', get_string('smartspename', 'mod_smartspe'), ['size' => '64']);
        ...
        $mform->addHelpButton('name', 'smartspename', 'mod_smartspe');
